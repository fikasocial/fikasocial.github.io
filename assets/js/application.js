$(document).ready(function(){
    ...
    */
    ...
    if(typeof(window.ontouchstart) != 'undefined') {
        var touchElements = ['.social-icons a', '.menu-items li', '.about-items .item']
    ...
    */
    ...
    setTimeout(function() {
       ...
       if (document.getElementById('twitterfeed-slider')
           && (0 !==  document.getElementById('twitterfeed-slider').firstChild.children.length)) {
...
$(document).ajaxComplete(function() {
    ...
    // Menu details - close.
    $('.close-menu span').click(function(e) {
        $('.menu-item-details').delay(500).slideUp(500, function() {
            $(this).remove()
        })
